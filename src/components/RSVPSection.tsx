...
const RSVPSection = () => {
  const subject = encodeURIComponent("RSVP - Wedding");
  const body = encodeURIComponent("Name:\nNumber of Guests:\nAttending Events:\n");
  const mailto = `mailto:rsvp@danielandtina2026.com?subject=${subject}&body=${body}`;
  ...
  return (
    <section id="rsvp" className="py-24 px-4">
      ...
      <div className="max-w-lg mx-auto bg-accent/40 rounded-xl p-10 text-center">
        ...
        <a
          href={mailto}
          className="inline-block font-body text-sm uppercase tracking-widest bg-primary text-primary-foreground rounded-full px-10 py-3 hover:opacity-90 transition-opacity"
        >
          RSVP Now
        </a>
        <div className="mt-8 text-sm text-muted-foreground font-body">
